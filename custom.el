(custom-set-variables
 ...
 '(safe-local-variable-directories '("/Users/daw-ranliou/kira/"))
 '(safe-local-variable-values
   '((lsp-go-build-flags .
                         ["-tags=integration,nightly,gamie,docgroups,execution"])
     (org-babel-clojure-backend quote cider)
     (cider-clojure-cli-global-options . -A:dev)
     (lsp-go-use-gofumpt . t)
     (cljr-warn-on-eval)
     (sql-postgres-login-params quote
                                ((user :default "de_firmadm")
                                 (database :default "de_kirasystems_com")
     ...
     (cider-lein-parameters . "with-profile +test repl :headless :host localhost")))
