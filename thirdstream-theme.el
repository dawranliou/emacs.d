...
;;; Code:
 ...
 (let ((class '((class color) (min-colors 89)))
       ...
       (bg4 "#c2c2c2")
       (bg-highlight "#fbf1a9")
       (bg-highlight-2 "#9eebcf")
       (bg-highlight-3 "#cdecff")
       (bg-highlight-4 "#ff725c")
       (builtin "#111111")
       (keyword "#111111")
       (const   "#111111")
       (comment "#606060")
   ...
   'thirdstream
	...
	`(font-lock-constant-face ((,class (:foreground ,const))))
        ...
        `(font-lock-string-face ((,class (:foreground ,str :background ,bg-highlight-3))))
        `(font-lock-type-face ((,class (:foreground ,type ))))
        `(font-lock-variable-name-face ((,class (:foreground ,var))))
        `(font-lock-warning-face ((,class (:foreground ,warning :background ,bg2))))
        `(term-color-black ((,class (:foreground ,fg :background nil))))
        `(region ((,class (:foreground ,fg :background ,bg-highlight))))
        `(highlight ((,class (:foreground ,fg :background ,bg-highlight))))
	`(hl-line ((,class (:background  ,bg2))))
	`(fringe ((,class (:background ,bg2 :foreground ,fg))))
	`(cursor ((,class (:background ,fg :foreground ,bg1))))
        `(show-paren-match-face ((,class (:background ,warning))))
        `(isearch ((,class (:bold t :foreground ,warning :background ,bg3))))
        `(mode-line ((,class (:box (:line-width 1 :color nil) :bold t :foreground ,fg :background ,bg2))))
	...
	`(org-hide ((,class (:foreground ,fg))))
        ...
        `(org-agenda-structure ((,class (:weight bold :foreground ,fg :box (:color ,fg) :background ,bg3))))
	...
	`(slime-repl-inputed-output-face ((,class (:foreground ,type))))
        ...
        `(magit-diff-context-highlight ((,class (:background ,bg3 :foreground ,fg))))
        ...
        `(magit-diff-file-header ((,class (:foreground ,fg :background ,bg3))))
        `(lazy-highlight ((,class (:foreground ,fg :background ,bg3))))
        ...
        `(helm-header ((,class (:foreground ,fg :background ,bg1 :underline nil :box nil))))
        `(helm-source-header ((,class (:foreground ,keyword :background ,bg1 :underline nil :weight bold))))
        `(helm-selection ((,class (:background ,bg2 :underline nil))))
        `(helm-selection-line ((,class (:background ,bg2))))
        `(helm-visible-mark ((,class (:foreground ,bg1 :background ,bg3))))
        `(helm-candidate-number ((,class (:foreground ,bg1 :background ,fg))))
        ...
        `(company-echo-common ((,class (:foreground ,bg1 :background ,fg))))
        `(company-preview ((,class (:background ,bg2 :foreground ,var))))
        `(company-preview-common ((,class (:foreground ,bg2 :foreground ,fg))))
        `(company-preview-search ((,class (:foreground ,type :background ,bg1))))
        `(company-scrollbar-bg ((,class (:background ,bg3))))
        `(company-scrollbar-fg ((,class (:foreground ,keyword))))
        `(company-tooltip ((,class (:foreground ,fg :background ,bg2 :bold t))))
