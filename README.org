...
[[https://github.com/smihica/emmet-mode][Emmet-mode]] is a neat way to write markup quickly in Emacs. Use =emmet-expand-line=
(bound to =C-j= by default) to expand the emmet snippets. See the [[https://docs.emmet.io/cheat-sheet/][cheat-sheet]] to
find the full list of aliases/keywords.
