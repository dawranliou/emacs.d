...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; Org
   `(org-document-title ((,class (:foreground ,fg2 :height 1.4))))
   `(org-hide ((,class (:inherit 'fixed-pitch :foreground ,bg1))))
   `(org-level-1 ((,class (:foreground ,fg2 :height 1.3 :box (:line-width 2 :color ,bg1)))))
   `(org-level-2 ((,class (:foreground ,fg3 :height 1.2 :box (:line-width 2 :color ,bg1)))))
   `(org-level-3 ((,class (:foreground ,fg3 :height 1.1 :box (:line-width 2 :color ,bg1)))))
   `(org-level-4 ((,class (:foreground ,fg3 :height 1.1 :box (:line-width 2 :color ,bg1)))))
   `(org-level-5 ((,class (:foreground ,fg3 :height 1.1))))
   `(org-level-6 ((,class (:foreground ,fg3 :height 1.1))))
   `(org-level-7 ((,class (:foreground ,fg3 :height 1.1))))
   `(org-level-8 ((,class (:foreground ,fg3 :height 1.1))))
