...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(mode-line ((,class (:foreground ,fg3 :background ,bg2))))
   `(mode-line-inactive ((,class (:foreground ,fg4 :background ,bg1))))
   ...
   `(org-level-1 ((,class (:foreground ,fg2 :height 1.3))))
   `(org-level-2 ((,class (:foreground ,fg3 :height 1.2))))
   `(org-level-3 ((,class (:foreground ,fg3 :height 1.1))))
   `(org-level-4 ((,class (:foreground ,fg3 :height 1.1))))
